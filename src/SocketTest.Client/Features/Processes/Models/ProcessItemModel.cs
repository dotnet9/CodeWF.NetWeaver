...
public class ProcessItemModel : ReactiveObject
{
    ...
    public void Update(ProcessItem process, int timestampStartYear)
    {
        ...
        Gpu = process.Gpu;
        GpuEngine = Enum.Parse<GpuEngine>(process.GpuEngine.ToString());
        PowerUsage = Enum.Parse<PowerUsage>(process.PowerUsage.ToString());
        PowerUsageTrend = Enum.Parse<PowerUsage>(process.PowerUsageTrend.ToString());
        Type = Enum.Parse<ProcessType>(process.Type.ToString());
        Status = Enum.Parse<ProcessStatus>(process.ProcessStatus.ToString());
    ...
    {
        Status = Enum.Parse<ProcessStatus>(processStatus.ToString());
        AlarmStatus = Enum.Parse<AlarmStatus>(alarmStatus.ToString());
        Gpu = gpu;
        GpuEngine = Enum.Parse<GpuEngine>(gpuEngine.ToString());
        PowerUsage = Enum.Parse<PowerUsage>(powerUsage.ToString());
        PowerUsageTrend = Enum.Parse<PowerUsage>(powerUsageTrend.ToString());
